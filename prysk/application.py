            ...
            try:
                if isbool:
                    try:
                        ...
                        self.error("--%s: invalid boolean value: %r" % (key, value))
                else:
                    value = config.get("prysk", key)
...
def _parseopts(args):
    ...
    p.add_option("-q", "--quiet", action="store_true", help="don't print diffs")
    p.add_option(
        "-v", "--verbose", action="store_true", help="show filenames and test status"
    )
    p.add_option(
        "-i",
        "--interactive",
    ...
    p.add_option("-y", "--yes", action="store_true", help="answer yes to all questions")
    p.add_option("-n", "--no", action="store_true", help="answer no to all questions")
    p.add_option(
        "-E",
        "--preserve-env",
        action="store_true",
    ...
    p.add_option(
        "--keep-tmpdir", action="store_true", help="keep temporary directories"
    )
    p.add_option(
        "--shell",
        action="store",
